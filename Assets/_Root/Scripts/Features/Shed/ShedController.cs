...
namespace Features.Shed
{
    ...
    internal class ShedController : BaseController, IShedController
    {
        ...
        private void Apply()
        {
            ...
            Log($"Apply. Speed: {_profilePlayer.CurrentCar.Speed}, Jump: {_profilePlayer.CurrentCar.JumpHeight}, Shield {_profilePlayer.CurrentCar.Shield}");
        }

        private void Back()
        {
            _profilePlayer.CurrentState.Value = GameState.Start;
            Log($"Back. Speed: {_profilePlayer.CurrentCar.Speed}, Jump: {_profilePlayer.CurrentCar.JumpHeight}, Shield {_profilePlayer.CurrentCar.Shield}");
        }

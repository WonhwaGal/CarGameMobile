...
namespace Rewards
{
    ...
    {
        private readonly RegularRewardView _view;
        ...
        public RewardController(RegularRewardView view) =>
            _view = view;
        ...
        private void RefreshSlots()
        {
            for (var i = 0; i < _slots.Count; i++)
            {
                ...
                _slots[i].SpanName = _view.TimespanName;

                _slots[i].SetData(reward, countSpan, isSelected);
            }
        }
    }
}
